...
class Graph_pred(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        # LiuC:在text_encoder、graph_encoder的参数中添加prompt embedding
        # 如下：
        # text_feature = self.text_encoder(text_batch, text_mask_batch, prompt_t)
        # graph_feature = self.graph_encoder(x, attn_bias, attn_edge_type, spatial_pos,
        #                                    in_degree, out_degree, edge_input, prompt_g)
