...
parser.add_argument('--input_file', type=str, default='../save_model/task3_caption/output_base/0826_200k/base_out_v1_2e_5_0826.txt', help='path where test generations are saved')
