...
if __name__ == "__main__":
    ...
    parser.add_argument('--text_model', type=str, default='scibert', help='Desired language model tokenizer.')

    # parser.add_argument('--input_file', type=str, default='../save_model/task3_caption/output_base/base_out_v2_2e_5_1e_4.txt',
    #                     help='path where test generations are saved')
    parser.add_argument('--input_file', type=str, default='../save_model/task3_caption/output_small/1022_Miss_1M_200k/small_out_v1_3e_5_1022.txt',
                        help='path where test generations are saved')

    parser.add_argument('--text_trunc_length', type=str, default=512, help='tokenizer maximum length')
    # parser.add_argument('--text_trunc_length', type=str, default=128, help='tokenizer maximum length')
