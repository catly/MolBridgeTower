...
from data_provider.collator import collator, Batch
...
class GraSTPretrain_STM(Dataset):
    ...
    def __getitem__(self, index):
        ...
        smile_path = '../preprocessing/PubChemSTM/PubChemSTM_process/smiles_PubChemSTM/text' + '_' + f"{self.ids[idx]}.txt"
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        for idx, batch in enumerate((train_dataloader)):
            ...
            text_feature = text_encoder(text_batch, text_mask_batch)
