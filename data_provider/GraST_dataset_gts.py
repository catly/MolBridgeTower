...
class GraSTMatchDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        smiles_path = 'data/kv_data/smiles_15k/smiles' + '_' + f"{self.ids[idx]}.txt"
        ...
        text = mask = None
        smiles = smiles_mask = None

        # if self.data_type == 'para':  # paragraph-level
        text, mask = self.tokenizer_text(text_list[0])
        smiles, smiles_mask = self.tokenizer_smiles(smiles_list[0])

        # LiuC:
        data_graph_text.text = text
        data_graph_text.text_mask = mask
        data_graph_text.smiles = smiles
        data_graph_text.smiles_mask = smiles_mask
    ...
    def tokenizer_smiles(self, smiles):
        tokenizer = self.tokenizer
        sentence_token = tokenizer(text=smiles,
                                   truncation=True,
                                   padding='max_length',
                                   add_special_tokens=False,
...
class GraSTMatchDataset_MoMu(Dataset):
    ...
    def __getitem__(self, index):
        ...
        smiles_path = 'data/MoMu_data/smiles/smiles' + '_' + f"{self.ids[idx]}.txt"
        # smile_path = '../data/kv_data/smiles_15k/smiles' + '_' + f"{self.ids[idx]}.txt"
...
class GraSTPretrain_STM(Dataset):
    ...
    def __getitem__(self, index):
        ...
        smiles_path = 'preprocessing/PubChemSTM/PubChemSTM_process/smiles_PubChemSTM/smiles' + '_' + f"{self.ids[idx]}.txt"
        # smile_path = '../data/kv_data/smiles_15k/smiles' + '_' + f"{self.ids[idx]}.txt"
        # LiuC: 0305
        # smiles_path = 'preprocessing/PubChemSTM/PubChemSTM_process/smiles_PubChemSTM/smiles' + '_' + f"{self.ids[idx]}.txt"
...
class GraSTPretrain_STM_1M(Dataset):
    def __init__(self, args, ids, scaf):
        # super(GraSTMatchDataset, self).__init__()
        super(GraSTPretrain_STM_1M, self).__init__()
        self.ids = ids
        self.scaf = scaf
        self.graph_aug = args.graph_aug
        self.text_max_len = args.text_max_len
    ...
    def __getitem__(self, index):
        ...
        # graph_path = './data/kv_data/graph/graph' + '_' + f"{self.ids[idx]}.pt"
        # text_path = './data/kv_data/text/text' + '_' + f"{self.ids[idx]}.txt"
        graph_path = 'preprocessing/ChEM_1M/graph_ChEM_1M/graph' + '_' + f"{self.ids[idx]}.pt"
        text_path = 'preprocessing/ChEM_1M/text_ChEM_1M/text' + '_' + f"{self.ids[idx]}.txt"
        smiles_path = 'preprocessing/ChEM_1M/smiles_ChEM_1M/smiles' + '_' + f"{self.ids[idx]}.txt"
        # smile_path = '../data/kv_data/smiles_15k/smiles' + '_' + f"{self.ids[idx]}.txt"
        # LiuC: 0305
        # smiles_path = 'preprocessing/PubChemSTM/PubChemSTM_process/smiles_PubChemSTM/smiles' + '_' + f"{self.ids[idx]}.txt"
...
class GraSTPretrain_STM_BBBP(Dataset):
    def __init__(self, args, ids, scaf):
        # super(GraSTMatchDataset, self).__init__()
        super(GraSTPretrain_STM_1M, self).__init__()
        self.ids = ids
...
class GraSTPretrain_STM_25k(Dataset):
    def __init__(self, args, ids, scaf):
        # super(GraSTMatchDataset, self).__init__()
        super(GraSTPretrain_STM_25k, self).__init__()
        self.ids = ids
        self.scaf = scaf
        self.graph_aug = args.graph_aug
        self.text_max_len = args.text_max_len
    ...
    def __getitem__(self, index):
        ...
        # graph_path = './data/kv_data/graph/graph' + '_' + f"{self.ids[idx]}.pt"
        # text_path = './data/kv_data/text/text' + '_' + f"{self.ids[idx]}.txt"
        graph_path = 'preprocessing/ChEM_25k/graph_ChEM_25k/graph' + '_' + f"{self.ids[idx]}.pt"
        text_path = 'preprocessing/ChEM_25k/text_ChEM_25k/text' + '_' + f"{self.ids[idx]}.txt"
        smiles_path = 'preprocessing/ChEM_25k/smiles_ChEM_25k/smiles' + '_' + f"{self.ids[idx]}.txt"
        # smile_path = '../data/kv_data/smiles_15k/smiles' + '_' + f"{self.ids[idx]}.txt"
        # LiuC: 0305
        # smiles_path = 'preprocessing/PubChemSTM/PubChemSTM_process/smiles_PubChemSTM/smiles' + '_' + f"{self.ids[idx]}.txt"
