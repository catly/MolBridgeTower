...
from MolProp.MoleculeNet_Graph import MoleculeNetGraphDataset, CustomDataset
from torch.utils.data import Dataset, DataLoader
from torch.utils.data import RandomSampler
from functools import partial
from MolProp.collator_prop_molBT import collator, Batch

from model.MolBT_gt import BT_Config

import torch.multiprocessing

from MolProp.splitters import scaffold_split
from MolProp.utils import get_num_task_and_type, get_molecule_repr_MoleculeSTM
# from Molprop_dataset.molecule_gnn_model import GNN, GNN_graphpred
# from MolProp.molBT_graph_model import Graph_pred
from MolProp.molBT_graph_model_1022 import Graph_pred
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr", type=float, default=4.9e-5)
    ...
    # parser.add_argument("--output_model_dir", type=str, default='save_model/task2_prop/muv/0728_wo_smiles')
    # parser.add_argument("--output_model_dir", type=str, default='save_model/task2_prop/muv/0826_200k')
    # parser.add_argument("--output_model_dir", type=str, default='save_model/task2_prop/bbbp/0831_1M_200k')
    parser.add_argument("--output_model_dir", type=str, default='save_model/task2_prop/bbbp/1022_Miss_1M_200k')
    ...
    for k, v in model_ckpt.items():
        new_key = k.replace('MolBT_encoder.', '')  # 去掉前缀
        new_state_dict[new_key] = v

    bt_config = BT_Config()
    model = Graph_pred(config=bt_config,
    ...
    if task_mode == "classification":
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for metric in metric_list:
                print('{} train: {:.6f}\tval: {:.6f}\ttest: {:.6f}'.format(metric, train_result[metric],
                                                                           val_result[metric], test_result[metric]))
            print()
