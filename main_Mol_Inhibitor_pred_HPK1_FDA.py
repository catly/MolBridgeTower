...
def eval_regression(model, device, loader):
    ...
    np.savez("molecule_data_HPK1_FDA.npz", molecule_repr=molecule_reprs, y_pred=y_pred)
    ...
    smiles_df.to_csv("smiles_list.csv", index=False)
...
if __name__ == "__main__":
    ...
    test_loader = DataLoader(test_dataset, shuffle=False,
                                 ...
                                 collate_fn=partial(collator, max_node=32,
                                                    multi_hop_max_dist=20, spatial_pos_max=20))


    test_ckpt_path = 'save_model/task4_tox/HPK1/HPK1_model_best.pth'
