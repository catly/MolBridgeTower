import argparse
from config_Miss import parse_args
...
# LiuC:
from data_provider.GraST_dataset_gts import  GraSTPretrain_STM_1M
from torch.utils.data import Dataset, DataLoader
from data_provider.collator_gts import collator, Batch
import torch_geometric
from model.contrastive_BTT_gt_Miss import MolBT_CL
...
def prepare_model_and_optimizer(args, device):
    # LiuC:
    ckpt_path = 'save_model/pretrain_1018_Miss_200k/model_20_42.ckpt'
...
def Eval(model, dataloader, device, args):
    ...
    with torch.no_grad():
        ...
        for idx, batch in enumerate((dataloader)):
            ...
            text_rep, graph_rep, loss = model.training_eval_step(batch_idx=idx, batch=batch)
...
def main():
    ...
    text_name_list = os.listdir("preprocessing/ChEM_1M/text_ChEM_1M")
    ...
    TrainSet = GraSTPretrain_STM_1M(args, ids, scaf[0])
    DevSet = GraSTPretrain_STM_1M(args, ids, scaf[1])
